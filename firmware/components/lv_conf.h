...
#else       /*LV_MEM_CUSTOM*/
#define LV_MEM_CUSTOM_INCLUDE "freertos/FreeRTOS.h"   /*Header for the dynamic memory function*/
...
#define LV_VDB_PX_BPP       16      /*Bit-per-pixel of VDB. Useful for monochrome or non-standard color format displays. (Special formats are handled with `disp_drv->vdb_wr`)*/
...
#if USE_LV_LABEL != 0
#define LV_LABEL_SCROLL_SPEED       35     /*Hor, or ver. scroll speed [px/sec] in 'LV_LABEL_LONG_SCROLL/ROLL' mode*/
#endif
