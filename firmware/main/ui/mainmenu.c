...
const mm_icon_t mm_icontable[] = {
    ...
    {"Settings", "Adjust system settings.", &img_settings, &img_settings_half, UISCREEN_MAINMENU},
    {"About/Help", "Information, credits, acknowledgements.", &img_about, &img_about_half, UISCREEN_ABOUT},
};
